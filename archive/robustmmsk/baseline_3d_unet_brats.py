...
class Trainer:
    ...
    def run(self, train_files, val_files, epochs=300):
        ...
        train_ds = RobustCacheDataset(
            ...
            cache_rate=0.5,  # Cache 50% of data in RAM
            num_workers=4
        )
        ...
        for epoch in range(epochs):
            ...
            # dice_scores shape: [batch, num_classes]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_json", type=str, required=True, help="Path to dataset JSON")
    parser.add_argument("--output_dir", type=str, default="./output_baseline_brats", help="Output directory")
