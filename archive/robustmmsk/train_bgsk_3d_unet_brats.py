...
# Import BG-SK U-Net
from bgsk_3d_unet import BGSK3DUNet
...
class Trainer:
    def __init__(self, gpu_id, output_dir):
        ...
        # BG-SK 3D U-Net model
        self.model = BGSK3DUNet(in_channels=4, out_channels=4).to(self.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="./output_bgsk_tversky_brats")
