...
class Trainer:
    ...
    # ──────────────────────────────────────────────────────────────────────────
    def run(self, train_files: list[str], val_files: list[str], epochs: int = 300, resume_path: str | None = None):
...
if __name__ == "__main__":
    ...
    trainer.run(dataset["train"], dataset["val"], args.epochs, resume_path=args.resume)
